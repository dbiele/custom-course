 package com.invision.client.movies 
{
	 ...
	 * @author Dean Biele
	 */
	public class Frame06_Knoweldge_Content extends MovieClip 
	{
		...
		public function Frame06_Knoweldge_Content() 
		{
		...
		public function onStartInteraction(event:Event = null):void {
			...
			multipleChoiceQuestion = new CustomMultipleChoiceQuestion("quiz3");
			multipleChoiceQuestion.addAnswer("answer1", radiobutton1_mc, true, 100, "That’s Correct!");
			multipleChoiceQuestion.addAnswer("answer2", radiobutton2_mc, true, 100, "That’s Correct!");
			multipleChoiceQuestion.addAnswer("answer3", radiobutton3_mc, true, 100, "That’s Correct!");
			multipleChoiceQuestion.addAnswer("answer4", radiobutton4_mc, true, 100, "That’s Correct!");
